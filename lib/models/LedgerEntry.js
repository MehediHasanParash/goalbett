...
const LedgerEntrySchema = new mongoose.Schema(
  {
    ...
    transactionType: {
      ...
      enum: [
        ...
        "FEE_CHARGE",
        "TAX_DEDUCTION",
        // Tax & Regulatory Deductions
        "WIN_TAX_DEDUCTION",
        "BETTING_TAX_DEDUCTION",
        "WITHHOLDING_TAX_DEDUCTION",
        "VAT_DEDUCTION",
        "EXCISE_DUTY_DEDUCTION",
        "CHARITY_DEDUCTION",
        "SOCIAL_RESPONSIBILITY_DEDUCTION",
        "GAMING_LEVY_DEDUCTION",
        // Jackpot
    ...
    // Tax and deduction details (CRITICAL for compliance)
    taxDetails: {
      jurisdictionRuleId: {
        type: mongoose.Schema.Types.ObjectId,
