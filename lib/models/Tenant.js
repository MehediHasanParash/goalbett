...
TenantSchema.virtual("currency").get(function () {
  return this.default_currency || "USD"
})

TenantSchema.virtual("countryCode").get(function () {
  return this.metadata?.country ? this.metadata.country.substring(0, 2).toUpperCase() : "US"
})
