...
export default function TenantVouchersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A1A2F] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#FFD700]">Voucher Management</h1>
            <p className="text-[#F5F5F5]/70">Generate and manage prepaid vouchers for players</p>
          </div>
          <Button
        ...
        {success && (
          <div className="mb-4 p-4 rounded-lg bg-green-500/20 border border-green-500/30 text-green-400">{success}</div>
        )}
        {error && (
