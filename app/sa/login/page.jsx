...
export default function SubAgentLoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    const result = await login(email, password, ROLES.SUB_AGENT)
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A1A2F] via-[#0D1F35] to-[#0A1A2F] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#F5F5F5] mb-2">Sub-Agent Login</h1>
          <p className="text-[#B8C5D6]">Access your sub-agent dashboard</p>
        </div>
