...
import { Lock, Eye, EyeOff, Shield, User, Loader2, CheckCircle, AlertCircle, LogOut } from "lucide-react"
import { getAuthToken, parseToken, logout } from "@/lib/auth-service"
      ...
      <div className="md:ml-64 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-[#B8C5D6]">Manage your account settings and security</p>
          </div>
          ...
          <Card className="bg-[#0D1F35] border-[#2A3F55] mb-6">
            <CardHeader>
              ...
              <CardDescription className="text-[#B8C5D6]">Your agent account details</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-[#1A2F45] rounded-lg">
                  <p className="text-xs text-[#B8C5D6] mb-1">Full Name</p>
                  <p className="text-white font-medium">{user?.fullName || "Agent"}</p>
                </div>
                <div className="p-4 bg-[#1A2F45] rounded-lg">
                  <p className="text-xs text-[#B8C5D6] mb-1">Email</p>
                  <p className="text-white font-medium">{user?.email || "-"}</p>
                </div>
                <div className="p-4 bg-[#1A2F45] rounded-lg">
                  <p className="text-xs text-[#B8C5D6] mb-1">Role</p>
                  <p className="text-[#FFD700] font-medium capitalize">{user?.role || "Agent"}</p>
                </div>
                <div className="p-4 bg-[#1A2F45] rounded-lg">
                  <p className="text-xs text-[#B8C5D6] mb-1">User ID</p>
                  <p className="text-white font-medium text-xs">{user?.userId || "-"}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#0D1F35] border-[#2A3F55] mb-6">
            <CardHeader>
              ...
              <CardDescription className="text-[#B8C5D6]">Update your account password</CardDescription>
            </CardHeader>
            <CardContent>
              {message.text && (
                <div
