...
import { Users, Wallet, TrendingUp, Receipt, Plus, Eye, Trash2, LogOut, DollarSign, User } from "lucide-react"
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start mb-3">
                  ...
                  <div>
                    ...
                    <span
                      className={`inline-block px-2 py-1 rounded text-xs font-semibold ${agent.status === "active" ? "bg-green-500/20 text-green-400" : "bg-gray-500/20 text-gray-400"}`}
                    >
                      {agent.status}
                    </span>
                  </div>
